...
// For reference:
// https://github.com/mithrilcoin-io/UosCommander/blob/master/app/src/main/java/io/mithrilcoin/uoscommander/data/remote/model/types/UosByteWriter.java
...
func NewUOSAsset(amount int64) Asset {
	return Asset{Amount: Int64(amount), Symbol: UOSSymbol}
}

// NewAsset reads from a string an UOS asset.
//
...
// NewAssetFromString reads a string an decode it to an uos.Asset
...
func NewUOSAssetFromString(input string) (Asset, error) {
	return NewFixedSymbolAssetFromString(UOSSymbol, input)
}
