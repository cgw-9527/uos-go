...
func FixmeTestPackTransaction(t *testing.T) {
	...
	tx := &Transaction{
		...
		Actions: []*Action{
			{
				Account: AccountName("uosio"),
				Name:    ActionName("transfer"),
				Authorization: []PermissionLevel{
					{AccountName("uosio"), PermissionName("active")},
				},
			},
		},
	}
	...
	// actions: 01
	// - account: 0000000000ea3055 (uosio)
	//   action: 000000572d3ccdcd (transfer)
	//   []auths: 01
	//     - acct: 0000000000ea3055 (uosio)
...
func TestPackAccountName(t *testing.T) {
	// SHOULD IMPLEMENT: string_to_name from contracts/uosiolib/types.hpp
	tests := []struct {
		in  string
		out string
	}{
