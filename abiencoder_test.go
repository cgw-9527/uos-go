...
var abiData = []byte(`{
	...
	"struct_1_field_1": Name("lialvincom"),
	"struct_1_field_2": M{
...
func TestABI_Write(t *testing.T) {
	testCases := []map[string]interface{}{
		...
		{"caseName": "extended_asset", "typeName": "extended_asset", "expectedValue": "0a0000000000000004454f5300000000202932c94c833055", "json": "{\"testField\":{\"asset\":\"0.0010 UOS\",\"Contract\":\"lialvincom\"}}", "expectedError": nil},
		{"caseName": "extended_asset err", "typeName": "extended_asset", "expectedValue": "", "json": "{\"testField\":{\"asset\":\"abc.0010 UOS\",\"Contract\":\"lialvincom\"}}", "expectedError": fmt.Errorf("writing field: extended_asset: strconv.ParseInt: parsing \"abc0010\": invalid syntax")},
