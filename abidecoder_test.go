...
func TestABI_DecodeAction(t *testing.T) {
	...
	assert.Equal(t, "tkblackcom", gjson.GetBytes(json, "struct_1_field_1").String())
...
func TestABI_decodeFields(t *testing.T) {
	...
	assert.JSONEq(t, `{"F1":"18446744073709551615", "F2":"tkblackcom"}`, string(json))
}
...
func TestABI_Read(t *testing.T) {
	...
	testCases := []map[string]interface{}{
		...
		{"caseName": "Name", "typeName": "name", "value": "\"tkblackcom\"", "encode": Name("tkblackcom"), "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		...
		{"caseName": "extended_asset", "typeName": "extended_asset", "value": "{\"asset\":\"0.0010 UOS\",\"Contract\":\"tkblackcom\"}", "encode": ExtendedAsset{Asset: Asset{Amount: 10, Symbol: UOSSymbol}, Contract: "tkblackcom"}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
