...
func Test_PublicKeyMarshalUnmarshal(t *testing.T) {
	cases := []struct {
		...
		{
			name:        "K1-UOS",
			key:         "UOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
			expectedKey: "UOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
		},
		{
			name:        "K1",
...
func TestPublicKey_MarshalJSON(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			name:         "K1-UOS",
			key:          "UOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
			expectedJSON: `"UOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"`,
		},
		{
			name:         "K1",
			key:          "PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
